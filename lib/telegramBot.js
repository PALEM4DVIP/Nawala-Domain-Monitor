...
// 🟢 Tambahan Format Baru untuk Domain Aman / Online
function formatDomainSafeAlert(domain) {
  return `🟢 <b>Domain Aman</b>\nDomain <b>${domain.domain}</b> dalam kondisi normal & bisa diakses.`;
}
...
module.exports = {
  sendTelegramAlert,
  formatDomainSafeAlert, // Jangan lupa di-export di sini
  formatNawalaAlert,
